...
//#define TF                                   
*/
int QUADRUPOLE,OCTUPOLE,GR,TF,ML1,MB1;
...
#define MBfactor (5.83e-16) // This is the factor infont of the dG1/dt equation of magnetic breaking, equation (5) in Hurley et al 2002 this is in Msun R_sun^2 yr-2
...
#define TV1 50. //50. //0.001 //50. ///50. //5. //50. //0.01 //5. //15.//100000000000.//2. //50. //10000000.//100. //50. //1000.//50.//9.3e4 //1000.//1000000000000. //50. //5. //yr Viscous times, which go into tidal dissipation rate.  
#define TV2 1. //0.000005 //1. //0.001//1. //1.5 //0.001 //1.5 //5.//100000000000.//0.5 //10000000. //12. //0.001 //12 //0.1//100000000000.//0.01 //0.03 //0.001 //5. %%% 0.03 with 
